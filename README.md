...
1. **User**
     a. **List Of Employees**
     b. **List of Resign Employees**
     c. **Logout**
2. **Supervisor**
   
     a. **List Of Employees**
     b. **List of Resign Employees**
     c. **Find Grade and Salary with NIP (Nomor Induk Pegawai)**
     d. **Logout**
...
3. **Admin**
     ...
     b. **List of Resign Employees**
     c. **Find Grade and Salary with NIP (Nomor Induk Pegawai)**
     d. **Update Employees Data**
     e. **Add New Employees Data**
     f. **Add Resign Employees Data**
     g. **Request Add Account**
     h. **Request Delete Account**
     i. **Logout**
   
4. **Super Admin**
   
     a. **Confirm Request Delete/Add Account**
     b. **Logout**
